...
class SomnService:
    ...
    async def runSomn(self, bucket_name: str, data, job_id: str, service: MinIOService, email_service: EmailService):
            ...
            if(db_job.email):
                try:
                    email_service.send_email(
                        ...
                        f'''The result for your ChemScraper Job is available at {self.somn_frontend_baseURL}/results/{db_job.job_id}''')
