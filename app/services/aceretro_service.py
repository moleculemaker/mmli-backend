...
class ACERetroService:
    ...
    async def scoreFromSmile(self, jobObject, phase: JobStatus):
    ...
    async def scoreFromSmile(self, bucket_name: str, filename: str, objectPath: str, jobId: str, service: MinIOService, email_service: EmailService):
        # Get Job Object
